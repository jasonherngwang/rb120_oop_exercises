...
The module Mailing is not mixed into class PostalService, so invoking #send on 
johns_postal_services invokes the method Object#send which invokes the 
method (a Symbol) passed as an argument, plus any additional arguments.

To fix, mixin Mailing into PostalService.
=end
